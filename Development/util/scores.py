...
class ScoreReport:
    ...
    def generate_score_report(self):
        output = open(self.output_dir + '/' + self.model_name.replace(' ', '_').lower() + '_score-report.md', 'wb')
    ...
    def output_roc_csv(self, k, tpr, fpr, average=False):
        if average:
            output = open(self.output_dir + '/' + self.model_name.replace(' ', '_').lower() + '_AVG_KF-'+str(k)+'.csv', 'wb')
        else:
            output = open(self.output_dir + '/' + self.model_name.replace(' ', '_').lower() + '_KF-'+str(k)+'.csv', 'wb')
