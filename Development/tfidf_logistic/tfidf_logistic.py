...
report = ScoreReport('Tf-Idf + Logistic Regression')  # Automated Score Reporting Utility
...
for i, (train_idx, test_idx) in enumerate(kf.split(X)):
    ...
    y_pred = logistic.predict(X[test_idx])
    y_prob = logistic.predict_proba(X[test_idx])
    # Append to Report
